    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Your trusted platform for finding and booking accommodations with ease. Discover your perfect stay today.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about" className="text-gray-400 hover:text-blue-500 text-sm">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/listings" className="text-gray-400 hover:text-blue-500 text-sm">
                  Browse Listings
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-blue-500 text-sm">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>Address: 123 StayEase Lane, Travel City, USA</li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6 text-center">
          ...
          <div className="mt-2">
            <Link to="/privacy" className="text-gray-400 hover:text-blue-500 text-sm mx-2">
              Privacy Policy
            </Link>
            <span className="text-gray-400">|</span>
            <Link to="/terms" className="text-gray-400 hover:text-blue-500 text-sm mx-2">
              Terms of Service
            </Link>
          </div>
        </div>
